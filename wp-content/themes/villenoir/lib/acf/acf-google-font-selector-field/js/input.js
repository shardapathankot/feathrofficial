                ...
                jQuery(document).on( 'change', '.acfgfs-font-family select', function(){
                    ...
                    jQuery.ajax({
                        ...
                        success: function( response ) {
                            ...
                            link         = web_safe.indexOf(new_font) === -1 ? '<link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=' + font + '">' : '';
                ...
                jQuery(document).on( 'change', '.acfgfs-font-family select', function(){
                    ...
                    jQuery.ajax({
                        ...
                        success: function( response ) {
							...
							font     = new_font.replace(' ', '+');
                            web_safe = ['Georgia', 'Palatino Linotype', 'Book Antiqua', 'Palatino', 'Times New Roman', 'Times', 'Arial', 'Helvetica', 'Arial Black', 'Gadget', 'Impact', 'Charcoal', 'Lucida Sans Unicode', 'Lucida Grande', 'Tahoma', 'Geneva', 'Trebuchet MS', 'Helvetica', 'Verdana', 'Geneva', 'Courier New', 'Courier', 'Lucida Console', 'Monaco'];
                            link     = web_safe.indexOf(new_font) === false ? '<link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=' + font + '">' : '';
